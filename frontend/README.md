...
Um, so I want to create a notification that would, um, um, would be front end for this, and I already want to start thinking about creating the back end. So right now for the back end, I want you to just mock the calls to back end and then later I will implement back end myself. Um, so the reason I'm doing. System Design Interview Platform
